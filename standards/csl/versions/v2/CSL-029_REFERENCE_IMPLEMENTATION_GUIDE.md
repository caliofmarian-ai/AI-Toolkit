...
This specification defines normative requirements for CSL v2 reference implementation guide behavior.
...
1. Reference implementation SHALL cover lexer, parser, AST, semantic analysis, compiler, validator, and diagnostics.
2. Implementation SHALL provide reproducible build and test pathways.
3. Conformance suite results SHALL accompany reference release.
4. Known deviations SHALL be explicitly documented.
5. Reference implementation updates SHALL track standard version changes.
