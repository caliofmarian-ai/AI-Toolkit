...
This specification defines normative requirements for CSL v2 validator specification behavior.
...
1. Validator SHALL enforce syntax, semantics, dependencies, governance, and traceability rules.
2. Validator profiles SHALL support local, CI, and release gates.
3. Rule definitions SHALL be versioned and machine-readable.
4. Waivers SHALL be explicit and time-bound.
5. Validator output SHALL integrate with completion evidence reports.
