...
This specification defines normative requirements for CSL v2 language evolution behavior.
...
1. Evolution SHALL proceed through proposal, review, approval, release, and migration stages.
2. Breaking changes SHALL require major version transition.
3. Deprecation SHALL include migration guidance and sunset windows.
4. Evolution decisions SHALL be evidence-backed.
5. Emergency governance path SHALL exist for critical defects.
