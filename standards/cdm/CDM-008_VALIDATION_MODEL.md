...
This specification defines the normative validation model requirements for Canonical Document Model conformance.
...
1. Validation SHALL run in stages: syntax, structure, semantics, dependencies, governance, and traceability.
2. Each stage SHALL emit deterministic pass/fail output and machine-readable diagnostics.
3. Validation profiles SHALL support local, CI, and release gates.
4. Waivers SHALL be explicit, time-bound, and approval-linked.
5. Validation evidence SHALL be stored as canonical artifacts.
