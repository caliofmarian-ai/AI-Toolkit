...
This specification defines the normative traceability model requirements for Canonical Document Model conformance.
...
1. Traceability chain SHALL link intent, requirement, specification, implementation artifact, and validation evidence.
2. Each traceability link SHALL include creator, timestamp, reason, and confidence classification.
3. Orphan requirements without traceability links SHALL fail conformance checks.
4. Traceability SHALL support forward and backward traversal.
5. Traceability data SHALL be queryable through CDM-012 semantics.
