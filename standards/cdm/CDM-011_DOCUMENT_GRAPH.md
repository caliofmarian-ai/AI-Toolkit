...
This specification defines the normative document graph requirements for Canonical Document Model conformance.
...
1. Document graph SHALL be a directed labeled multigraph.
2. Node types SHALL include document, section, requirement, and evidence.
3. Edge types SHALL include depends_on, refines, supersedes, validates, and governed_by.
4. Graph generation SHALL be deterministic and reproducible.
5. Orphan nodes and invalid edges SHALL be reported as validation defects.
