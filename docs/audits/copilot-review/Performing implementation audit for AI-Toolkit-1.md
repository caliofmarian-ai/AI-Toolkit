...
Youcreated the session2 minutes ago· GPT-5.4 ·1 session· 32.1 AI credits
Youstarted a task
...
Find files **/*
View repository
Search CSL|csl|standard
View 5 files
README.md
standards/csl/CSL_RELEASE_1_0.md
requirements.txt
standards/csl/specification/08_REFERENCE_IMPLEMENTATION.md
standards/csl/rfc/RFC-0009-CANONICAL-PROJECT-STRUCTURE.md
Find files lib/python/*
View 2 files
standards/csl/tests/conformance/CONFORMANCE_LEVELS.md
standards/csl/specification/05_COMPILER_SPECIFICATION.md
Find files lib/*.sh
View standards/csl/specification/07_SAFETY_AND_GOVERNANCE.md
Find files
bin/*
lib/python/**/*.py
Search 2 times
...
Search CanonicalParser|CanonicalRepository|ComplianceEngine|WorkspaceIndexBuilder|ValidationEngine|EngineeringPipeline|RuntimeBootstrap|class .*Engine
View 2 files
bin/ai
bin/runtime-server
Search __main__|argparse|if __name__ == ['"]__main__['"]|main\(
View 5 files
...
Approve plan and start work1
Approve plan and start work
Copilot will implement the plan end-to-end
↵
2
Exit plan mode and I will prompt myself
