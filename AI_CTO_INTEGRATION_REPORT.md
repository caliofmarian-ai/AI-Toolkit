...
| Generated | 2026-08-03 06:08 UTC |
...
| Internal Python modules | 176 |
| Import graph edges | 468 |
...
| `lib/python/semantic_repository_intelligence/__init__.py` ⭐ | 4 |
...
| ---: | --- | --- | ---: | --- | --- | --- |
| 1 | 🟡 Medium | Investigate 58 orphan modules | 100% | small | medium | low |
...
| Critical module: lib/python/executable_repository_intelligence/models.py | dependency | ℹ️ Info | 90% |
| 1 decorator patterns detected | pattern | ℹ️ Info | 80% |
| 37 di_container patterns detected | pattern | ℹ️ Info | 80% |
| 17 event_bus patterns detected | pattern | ℹ️ Info | 80% |
...
| Metric | Value |
| --- | ---: |
| Total files analysed | 283 |
| Total symbols (classes + functions) | 894 |
| Total import statements | 468 |
| Total functions | 687 |
| Total classes | 207 |
| Avg imports per module | 1.6 |
| Avg functions per file | 2.4 |
