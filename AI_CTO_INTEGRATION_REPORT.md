...
| Generated | 2026-08-05 03:01 UTC |
...
- `implementation-packages/CORE-023/validation-report.md`
- `implementation-packages/PLATFORM/repository-audit.md`
- `lib/python/ai_cto_scanner/detectors.py`
...
- [x] **Development Readiness** ready (current: 92%)
...
| **Development Readiness** | █████████░ 92% | ✅ Ready |
...
| **Semantic Analysis** | 22 | 17 | 8 |
| **Testing** | 5 | 0 | 13 |
| **Uncategorised** | 157 | 60 | 111 |
| **Validation** | 8 | 10 | 5 |
| **Workspace** | 18 | 18 | 4 |

**Architecture edges (inter-layer dependencies):** 63

| From Layer | To Layer | Relationship | Strength |
| --- | --- | --- | ---: |
| Uncategorised | Core / Common | imports | 1.00 |
| CLI | Uncategorised | imports | 0.42 |
| Uncategorised | Planning | imports | 0.27 |
| Uncategorised | Semantic Analysis | imports | 0.27 |
| Planning | Uncategorised | imports | 0.24 |
| Uncategorised | Canonical Intelligence | imports | 0.24 |
| Agent Runtime | Uncategorised | imports | 0.20 |
| Testing | Uncategorised | imports | 0.20 |
| Uncategorised | Reporting | imports | 0.20 |
| Uncategorised | Scanning / Detection | imports | 0.16 |
| Uncategorised | Validation | imports | 0.11 |
| Scanning / Detection | Canonical Intelligence | imports | 0.09 |
| Testing | Planning | imports | 0.09 |
| Uncategorised | Workspace | imports | 0.09 |
...
| Internal Python modules | 336 |
| Import graph edges | 1250 |
...
| ---: | --- | --- | ---: | --- | --- | --- |
| 1 | 🟡 Medium | Investigate 84 orphan modules | 100% | small | medium | low |
...
| 191 di_container patterns detected | pattern | ℹ️ Info | 80% |
| 37 event_bus patterns detected | pattern | ℹ️ Info | 80% |
| 11 plugin_interface patterns detected | pattern | ℹ️ Info | 80% |
| 12 service_boundary patterns detected | pattern | ℹ️ Info | 80% |
...
| Metric | Value |
| --- | ---: |
| Total files analysed | 607 |
| Total symbols (classes + functions) | 2161 |
| Total import statements | 1250 |
| Total functions | 1623 |
| Total classes | 538 |
| Avg imports per module | 2.1 |
| Avg functions per file | 2.7 |
| Max imports in one module | 29 |
| Max functions in one file | 54 |
| Cyclomatic complexity estimate | 2.22 |
