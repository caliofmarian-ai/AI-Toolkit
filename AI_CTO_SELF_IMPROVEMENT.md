...
**Plan ID:** IMP-C4B7A581
**Generated:** 2026-08-03T13:10:03.384466+00:00
...
|--------|-------|------|-------|
| average_execution_duration_ms | 13804.2 | ms | degrading |
| evaluation_overall_score | 0.888 | score | improving |
| python_file_count | 248.0 | files | growing |
---
...
Improvement plan IMP-C4B7A581: 9 technical debt item(s), 3 capability gap(s), 12 proposed issue(s). All proposals require Owner approval before execution.
