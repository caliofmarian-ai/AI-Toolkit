...
**Evaluation ID:** ATK-EVAL-CB3B9DEE
**Generated:** 2026-08-05T03:01:11.657301+00:00
...
| overall_engineering_quality | `[████████░░] 87%` | PASS |
---
## Regressions (1 found)
...
- **[MEDIUM]** architecture_risk: {'id': 'ARCH-RISK-003', 'title': 'Architectural hotspot', 'description': 'lib/python/canonical_entities/__init__.py is imported by many modules, creating a high-coupling hub.', 'severity': 'medium', 'affected_modules': ['lib/python/canonical_entities/__init__.py'], 'evidence': ['in-degree: 11'], 'confidence': 0.85}
- **[MEDIUM]** architecture_risk: {'id': 'ARCH-RISK-004', 'title': 'Unclassified modules', 'description': '157 modules could not be assigned to a known architectural layer.', 'severity': 'low', 'affected_modules': ['lib/python/__init__.py', 'lib/python/autonomous_execution_engine/__init__.py', 'lib/python/autonomous_execution_engine/engine.py', 'lib/python/autonomous_execution_engine/evidence.py', 'lib/python/autonomous_execution_engine/logger.py', 'lib/python/autonomous_execution_engine/persistence.py', 'lib/python/autonomous_execution_engine/policy.py', 'lib/python/autonomous_execution_engine/rollback.py', 'lib/python/autonomous_execution_engine/validator.py', 'lib/python/autonomous_planner/__init__.py'], 'evidence': ['Layer classification: Uncategorised'], 'confidence': 0.7}
...
---
## Summary
Evaluation ATK-EVAL-CB3B9DEE completed. Overall engineering quality: 87% (PASS). Repository: AI-Toolkit.
