...
├── [ ] rezultatele epistemice relevante
├── [ ] identitățile semantice relevante
├── [ ] clasa epistemică
├── [ ] autoritatea
├── [ ] proveniența
├── [ ] incertitudinea
...
## [ ] E14 — Controlul dimensiunii contextului mental

└── [ ] T10 — Context Budget Governance

Scop uman:
Organismul trebuie să limiteze câtă informație ține simultan în memoria sa de
lucru și să evite supraîncărcarea furnizorului AI.
...
## [ ] E15 — Funcționarea în paralel a fiziologiei vechi și a celei cognitive
...
## [ ] E16 — Prima trecere reală la noua fiziologie pentru cererea simplă „hi”

└── [ ] T12 — Default Cognitive Cutover
...
## [ ] E17 — Cercetarea reală fără supraîncărcarea care producea OpenAI 429

└── [ ] T13 — Research-path Cognitive Cutover / Provenance Validation
...
## [ ] E18 — Legarea sesiunii de parcursul cognitiv

└── [ ] T14 — Session / Journey Integration

Scop uman:
Conversația persistentă și parcursul cognitiv trebuie să poată coopera fără
să devină același lucru.
...
Etapa curentă: E13 — Formarea contextului mental de lucru

Task tehnic curent: T9 — Working Context Assembly
