...
└── [>] T10 — Context Budget Governance
    ...
    ├── [ ] capacitatea modelului este preluată direct din ProviderRegistry
    ├── [ ] payload-ul guvernat este conectat la provider boundary
    └── [ ] acceptance multi-provider/model asupra requestului serializat
...
Stare:
ÎN IMPLEMENTARE — POLITICA DE BUGET DEMONSTRATĂ; INTEGRAREA PROVIDER RĂMÂNE
